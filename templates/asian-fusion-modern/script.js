...
// Hero slider functionality (if multiple images)
...
document.querySelectorAll('.menu-item, .philosophy-text, .chef-text').forEach(el => {
    el.style.opacity = '0';
...
window.addEventListener('scroll', () => {
    ...
    const parallax = document.querySelector('.hero-slide img');
    if (parallax) {
