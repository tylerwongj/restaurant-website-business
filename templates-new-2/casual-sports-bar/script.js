...
document.querySelectorAll('.btn-order-item').forEach(button => {
    button.addEventListener('click', function(e) {
        e.preventDefault();
        const itemName = this.closest('.menu-item').querySelector('h3').textContent;
        alert(`Order placed for ${itemName}! You will be redirected to our ordering system.`);
    });
});

// Loyalty program sign-up
document.querySelector('.btn-loyalty').addEventListener('click', function(e) {
    e.preventDefault();
    alert('Loyalty program sign-up coming soon! Stay tuned for exclusive rewards.');
});
