...
const server = http.createServer((req, res) => {
    ...
    // Handle root request - serve index.html from current directory
    if (filePath === '/') {
        filePath = '/index.html';
    }
    ...
    // If requesting templates, serve from parent directory
...
server.listen(PORT, () => {
    console.log(`🚀 Enhanced Template Gallery Server running at:`);
    console.log(`   http://localhost:${PORT}/`);
    console.log(`   http://localhost:${PORT}/templates/`);
    console.log('');
    console.log('📁 Serving files from:', BASE_DIR);
    console.log('🎯 Enhanced Template Gallery:', `http://localhost:${PORT}/`);
    console.log('');
